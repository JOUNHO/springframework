...
<form id="joinForm" name="joinForm" method="post" action="join" onsubmit="validate()" novalidate>
  ...
  <div class="form-group">
    ...
    <span id="errorUid"class="text-danger small"></span>
  </div>
  <div class="form-group">
    <label for="uname">회원</label>
    <input type="text" class="form-control" id="uname" name="uname">
        <span id="errorUname"class="text-danger small"></span>
    
  </div>
  <div class="form-group">
    <label for="upassword">비밀번호 확인</label>
    <input type="password" class="form-control" id="upassword" name="upassword">
    <span id="errorUpassword"class="text-danger small"></span>
  </div>
  <div class="form-group">
    <label for="uemail">이메일</label>
    <input type="email" class="form-control" id="uemail" name="uemail">
    <span id="errorUemail"class="text-danger small"></span>
  </div>
