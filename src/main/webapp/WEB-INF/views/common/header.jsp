...
<html>
 ...
 <body>
   <div class="d-flex flex-column vh-100">
	...
	<div>
            <div>
            <%-- Session을 이용한 로그인 인증에 따른 UI 상태 선택 --%>
            ...
            <%-- Spring Security를 이용한 로그인 인증에 따른 UI 상태 선택 --%>
            ...
            <sec:authorize access="isAuthenticated()">
               ...
               <form method="post" class="d-inline-block" action="${pageContext.request.contextPath}/logout">
                 <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                <button class="tn btn-success btn-sm">로그아웃</button>
             </form>
          </sec:authorize>
